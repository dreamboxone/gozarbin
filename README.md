...
| گزینه | توضیح |
| --- | --- |
| **عبور مستقیم ترافیک ایران** | محدوده‌های IP ایران بدون تونل رد می‌شوند. پس از نصب یک بار به‌روزرسانی کنید. |
| **منبع فهرست IPv4 ایران** | نشانی دانلود محدوده‌های IPv4؛ به هر آینه‌ای قابل تغییر است. |
| **منبع فهرست IPv6 ایران** | نشانی دانلود محدوده‌های IPv6. |
| **استفاده از GeoIP و GeoSite‏** | قواعد sing-box برای تشخیص مقصد ایرانی بر اساس نام دامنه و IP. |
...
| **پروفایل مبهم‌سازی** | از `off` تا `aggressive`؛ روی شبکه‌های سخت‌گیر `gfw` را امتحان کنید. |
